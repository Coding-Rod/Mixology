...
"")
    ...
    def cal_update_val(self):
        ...
        self.label_22.setText(str(self.horizontalSlider.value())+" ml")
        self.label_26.setText(str(self.horizontalSlider_2.value())+" ml")
        self.label_18.setText(str(self.horizontalSlider_3.value())+" ml")
        self.label_19.setText(str(self.horizontalSlider_4.value())+" ml")
        self.label_21.setText(str(self.horizontalSlider_5.value())+" ml")
        self.label_20.setText(str(self.horizontalSlider_6.value())+" ml")
        self.label_24.setText(str(self.horizontalSlider_7.value())+" ml")
        self.label_23.setText(str(self.horizontalSlider_8.value())+" ml")
        self.label_25.setText(str(self.horizontalSlider_9.value())+" ml")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_19.setText(str(self.dat.bottles["4"][1])+" ml")
        self.label_21.setText(str(self.dat.bottles["5"][1])+" ml")
        self.label_20.setText(str(self.dat.bottles["6"][1])+" ml")
        self.label_24.setText(str(self.dat.bottles["7"][1])+" ml")
        self.label_23.setText(str(self.dat.bottles["8"][1])+" ml")
        self.label_25.setText(str(self.dat.bottles["9"][1])+" ml")
        self.label_27.setText(str(self.dat.bottles["10"][1])+" ml")
