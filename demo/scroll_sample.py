...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(20, 20, 300, 201))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 784, 291))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_5.setText(_translate("Form", "DOWN"))
        self.pushButton_6.setText(_translate("Form", "DOWN"))
        self.pushButton_7.setText(_translate("Form", "DOWN"))
        self.pushButton_8.setText(_translate("Form", "DOWN"))
        self.pushButton_9.setText(_translate("Form", "DOWN"))
